 ...
 (function () {
        ...
        Drawing.prototype.draw = function (oQRCode) {
          ...
          function drawQrcode(oQRCode) {
            ...
            if (_htOption.title) {
              ...
              _oContext.fillText(
                _htOption.title,
                this._elCanvas.width / 2, +_htOption.quietZone + _htOption.titleTop
              );
            }
            ...
            if (_htOption.subTitle) {
              ...
              _oContext.fillText(
                _htOption.subTitle,
                this._elCanvas.width / 2, +_htOption.quietZone + _htOption.subTitleTop
              );
            }
    ...
    function _getTypeNumber(sText, _htOption) {
      ...
      if (nType > QRCodeLimitLength.length) {
        throw new Error(
          'Too long data. the CorrectLevel.' + ['M', 'L', 'H', 'Q'][nCorrectLevel] +
          ' limit length is ' +
          nLimit
        );
      }
