    ...
    <div class="col-12 border-top ">
      <div id="qr-cell" class="row d-none qr-cell">
        <div class="d-flex justify-content-center">
          <span id="coin-name-template" class="d-none"><?php echo DONATION_COIN_ADDRESS?></span>
      ...
      <div id="qr-label-cell" class="d-flex justify-content-center mt-4 ">
        <p class="h4 text-justify color-ct-blue-light-variant fw-light fst-italic"><?php echo DONATION_SELECT_CRYPTO?> </p>
        </div>
    </div>
  </div>
</div>
